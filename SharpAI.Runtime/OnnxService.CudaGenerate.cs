                        ...
                        try
                        {
                            ...
                            try
                            {
                                ...
                                foreach (var c in cand)
                                {
                                    ...
                                    // If token is short and mostly non-alphanumeric (symbols/garbage), strongly penalize
                                    if (len <= 4 && (alphaRatio < 0.33 || printableRatio < 0.5))
                                    {
                                    ...
                                    {
                                        // also penalize tokens that contain unusual unicode replacement sequences
